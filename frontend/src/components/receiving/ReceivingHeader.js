  ...
  const handleCloseShipment =
    async () => {
      ...
      try {
        ...
        await fetch(
          `https://https://smart-inventory-backend-m3wf.onrender.coms/api/receiving/close/${shipmentId}`,
          {
            method: "PUT",
          }
        );
  ...
  const handleNewReceipt =
    async () => {
      ...
      try {
        ...
        const response = await fetch(
          `https://https://smart-inventory-backend-m3wf.onrender.coms/api/receiving/shipments/${shipment.id}/items`
        );
